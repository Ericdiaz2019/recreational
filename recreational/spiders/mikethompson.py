...
class mikethompson(scrapy.Spider):
    name = "mikethompson"


    def start_requests(self):
        web_links = {
            'Travel Trailer': 'https://www.mikethompson.com/new-rvs-for-sale?s=true&types=29&pagesize=12',
            'FifthWheel': 'https://www.mikethompson.com/new-rvs-for-sale?s=true&types=5&pagesize=12',
            'ToyHauler': 'https://www.mikethompson.com/new-rvs-for-sale?s=true&types=26%2C28&pagesize=12',
            'ClassC Gas': 'https://www.mikethompson.com/new-rvs-for-sale?s=true&types=16&pagesize=12',
            'ClassC Diesel': 'https://www.mikethompson.com/new-rvs-for-sale?s=true&types=17&pagesize=12',
            'ClassC ToyHauler Gas': 'https://www.mikethompson.com/new-rvs-for-sale?s=true&types=19&pagesize=12',
            'ClassC Super Diesel': 'https://www.mikethompson.com/new-rvs-for-sale?s=true&types=95&pagesize=12',
            'ClassB Gas': 'https://www.mikethompson.com/new-rvs-for-sale?s=true&types=13&pagesize=12',
            'ClassB Diesel': 'https://www.mikethompson.com/new-rvs-for-sale?s=true&types=116&pagesize=12',
            'ClassB Gas+': 'https://www.mikethompson.com/new-rvs-for-sale?s=true&types=14&pagesize=12',
            'ClassA Gas': 'https://www.mikethompson.com/new-rvs-for-sale?s=true&types=9&pagesize=12',
            'ClassA Diesel': 'https://www.mikethompson.com/new-rvs-for-sale?s=true&types=10&pagesize=12',
        }
    ...
    def parse_units(self, response):
        ...
        for unit in units:
            ...
            with open(f'DailyFiles/Mikethompson {today}.csv', 'a', newline='') as file:
                writer = csv.writer(file, quoting=csv.QUOTE_ALL)
                if file.tell() == 0:  # If file is empty, write header
                    writer.writerow(['Year','Company','Brand','FloorPlan','Msrp','Discount','Stock-Number','Unit Type','Location','Dealer','Date'])
                
                writer.writerow([unit_year,unit_company,unit_brand,unit_floor,unit_msrp,unit_discount,unit_stock,unit_category,unit_location,'Mikethompson',today])
