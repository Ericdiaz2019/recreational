...
manufacturer_list = [
    ...
    "Venture RV", "Winnebago", "Winnebago Industries Towables",'KZ','Leisure'
]
...
class craig(scrapy.Spider):
    name = "craig"


    def start_requests(self):
        web_links = {
            'Travel Trailer': 'https://www.craigsmithrv.com/rv-search?s=true&condition=1&pagesize=12&types=29',
            'FifthWheel': 'https://www.craigsmithrv.com/rv-search?s=true&condition=1&pagesize=12&types=5',
            'ToyHauler': 'https://www.craigsmithrv.com/rv-search?s=true&condition=1&pagesize=12&types=26',
            'ClassC Gas': 'https://www.craigsmithrv.com/rv-search?s=true&condition=1&pagesize=12&types=16',
            'ClassB Gas': 'https://www.craigsmithrv.com/rv-search?s=true&condition=1&pagesize=12&types=13',
            'ClassB Gas+': 'https://www.craigsmithrv.com/rv-search?s=true&condition=1&pagesize=12&types=15',
            'ClassA Gas' : 'https://www.craigsmithrv.com/rv-search?s=true&condition=1&pagesize=12&types=9'
        }
    ...
    def parse_units(self, response):
        ...
        for unit in units:
            ...
            with open(f'DailyFiles/CraihSmith {today}.csv', 'a', newline='') as file:
                writer = csv.writer(file, quoting=csv.QUOTE_ALL)
                if file.tell() == 0:  # If file is empty, write header
                    writer.writerow(['Year','Company','Brand','FloorPlan','Msrp','Discount','Stock-Number','Unit Type','Location','Dealer','Date'])
                
                writer.writerow([unit_year,unit_company,unit_brand,unit_floor,unit_msrp,unit_discount,unit_stock,unit_category,unit_location,'CraihSmith',today])
