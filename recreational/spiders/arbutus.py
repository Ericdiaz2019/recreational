...
class arbutus(scrapy.Spider):
    name = "arbutus"


    def start_requests(self):
        web_links = {
            'Travel Trailer': 'https://www.arbutusrv.ca/rv-search?s=true&condition=1&pagesize=12&types=29',
            'Fifth Wheel': 'https://www.arbutusrv.ca/rv-search?s=true&condition=1&pagesize=12&types=5',
            'ToyHauler': 'https://www.arbutusrv.ca/rv-search?s=true&condition=1&pagesize=12&types=28',
            'ClassC Gas': 'https://www.arbutusrv.ca/rv-search?s=true&condition=1&pagesize=12&types=16',
            'ClassC Diesel': 'https://www.arbutusrv.ca/rv-search?s=true&condition=1&pagesize=12&types=17',
            'ClassB Gas': 'https://www.arbutusrv.ca/rv-search?s=true&condition=1&pagesize=12&types=13',
            'ClassB Gas+': 'https://www.arbutusrv.ca/rv-search?s=true&condition=1&pagesize=12&types=14',
            'ClassA Gas': 'https://www.arbutusrv.ca/rv-search?s=true&condition=1&pagesize=12&types=9',
            'Destination Trailer' : 'https://www.arbutusrv.ca/new-rvs-for-sale?s=true&types=3&pagesize=12'
        }
    ...
    def parse_units(self, response):
        ...
        for unit in units:
            ...
            with open(f'DailyFiles/Arbutus {today}.csv', 'a', newline='') as file:
                writer = csv.writer(file, quoting=csv.QUOTE_ALL)
                if file.tell() == 0:  # If file is empty, write header
                    writer.writerow(['Year','Company','Brand','FloorPlan','Msrp','Discount','Stock-Number','Unit Type','Location','Dealer','Date'])
                
                writer.writerow([unit_year,unit_company,unit_brand,unit_floor,unit_msrp,unit_discount,unit_stock,unit_category,unit_location,'Arbutus',today])
