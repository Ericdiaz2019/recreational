...
class buckeyesportscenter(scrapy.Spider):
    name = 'buckeyesportscenter'  # Unique identifier for the spider
    
    def start_requests(self):
        # Dictionary of URLs the spider will start with
        urls = { 
            'Pontoon': 'https://www.buckeyesportscenter.com/default.asp?page=xNewInventory&s=Year&d=A#page=xNewInventory&vc=pontoon',  # Add more URLs as needed
        }
    ...
    def parse_units(self, response):
        ...
        for boats in units:
            ...
            with open(f'DailyFiles/Buckeye {today}.csv', 'a',newline='') as file:
