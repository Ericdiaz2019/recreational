...
class parris(scrapy.Spider):
    name = "parris"


    def start_requests(self):
        web_links = {
            'Travel Trailer': 'https://www.parrisrv.com/rv-search?s=true&condition=1&types=29&pagesize=12',
            'Fifth Wheel': 'https://www.parrisrv.com/rv-search?s=true&condition=1&types=5&pagesize=12',
            'ToyHauler': 'https://www.parrisrv.com/rv-search?s=true&condition=1&types=26%2C28&pagesize=12',
