...
class curtistrailer(scrapy.Spider):
    name = "curtistrailer"


    def start_requests(self):
        web_links = {
            'Travel Trailer': 'https://www.curtistrailers.com/new-rvs-for-sale?pagesize=12&s=true&types=29',
            'FifthWheel': 'https://www.curtistrailers.com/new-rvs-for-sale?pagesize=12&s=true&types=5',
            'ToyHauler': 'https://www.curtistrailers.com/new-rvs-for-sale?pagesize=12&s=true&types=26%2C28',
            'Teardrop Trailer': 'https://www.curtistrailers.com/new-rvs-for-sale?pagesize=12&s=true&types=102',
            'Truck Camper': 'https://www.curtistrailers.com/new-rvs-for-sale?pagesize=12&s=true&types=30',
        }
    ...
    def parse_units(self, response):
        ...
        for unit in units:
            ...
            with open(f'DailyFiles/CurtisTrailer {today}.csv', 'a', newline='') as file:
                writer = csv.writer(file, quoting=csv.QUOTE_ALL)
                if file.tell() == 0:  # If file is empty, write header
                    writer.writerow(['Year','Company','Brand','FloorPlan','Msrp','Discount','Stock-Number','Unit Type','Location','Dealer','Date'])
                
                writer.writerow([unit_year,unit_company,unit_brand,unit_floor,unit_msrp,unit_discount,unit_stock,unit_category,unit_location,'CurtisTrailer',today])
