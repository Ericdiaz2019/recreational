...
class pleasureland(scrapy.Spider):
    name = "pleasureland"


    def start_requests(self):
        web_links = {
            'Travel Trailer': 'https://www.pleasurelandrv.com/rv-search?s=true&condition=1&types=29&pagesize=12',
            'FifthWheel': 'https://www.pleasurelandrv.com/rv-search?s=true&condition=1&types=5&pagesize=12',
            'ToyHauler': 'https://www.pleasurelandrv.com/rv-search?s=true&condition=1&types=26%2C28&pagesize=12',
            'ClassC Gas': 'https://www.pleasurelandrv.com/rv-search?s=true&condition=1&pagesize=12&types=16',
            'ClassC Diesel': 'https://www.pleasurelandrv.com/rv-search?s=true&condition=1&pagesize=12&types=17',
            'ClassC Super Diesel': 'https://www.pleasurelandrv.com/rv-search?s=true&condition=1&pagesize=12&types=95',
            'ClassB Gas': 'https://www.pleasurelandrv.com/rv-search?s=true&condition=1&pagesize=12&types=13',
            'ClassB Diesel': 'https://www.pleasurelandrv.com/rv-search?s=true&condition=1&pagesize=12&types=116',
            'ClassB Diesel+': 'https://www.pleasurelandrv.com/rv-search?s=true&condition=1&pagesize=12&types=15',
            'ClassA Gas': 'https://www.pleasurelandrv.com/rv-search?s=true&condition=1&pagesize=12&types=9',
            'Teardrop Trailer': 'https://www.pleasurelandrv.com/rv-search?s=true&condition=1&pagesize=12&types=102',
            'Destination Trailer' : 'https://www.pleasurelandrv.com/rv-search?s=true&condition=1&pagesize=12&types=3'
        }
        ...
        for i in range(1, amount + 1):
            ...
            yield scrapy.Request(
                ...
                meta={
                    'playwright': True,
                    'playwright_page_methods': [
                        PageMethod("wait_for_selector", "li.pleasureland-custom-template"),
                    ],
    ...
    def parse_units(self, response):
        ...
        units = soup.find_all('li', class_='pleasureland-custom-template')
        ...
        for unit in units:
            ...
            with open(f'DailyFiles/Pleasureland {today}.csv', 'a', newline='') as file:
                writer = csv.writer(file, quoting=csv.QUOTE_ALL)
                if file.tell() == 0:  # If file is empty, write header
                    writer.writerow(['Year','Company','Brand','FloorPlan','Msrp','Discount','Stock-Number','Unit Type','Location','Dealer','Date'])
                
                writer.writerow([unit_year,unit_company,unit_brand,unit_floor,unit_msrp,unit_discount,unit_stock,unit_category,unit_location,'Pleasureland',today])
