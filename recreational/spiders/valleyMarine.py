...
class valleyMarine(scrapy.Spider):
    name = 'valleyMarine'  # Unique identifier for the spider
    
    def start_requests(self):
        # Dictionary of URLs the spider will start with
        urls = { 
            'Pontoon': 'https://www.vallelymarine.com/pontoons-for-sale--xAllInventory?vc=pontoon#page=xAllInventory&p=1&vt=boat&vc=pontoon',  # Add more URLs as needed
        }
    ...
    def parse_units(self, response):
        ...
        for boats in units:
            ...
            with open(f'DailyFiles/Valley Marine {today}.csv', 'a',newline='') as file:
