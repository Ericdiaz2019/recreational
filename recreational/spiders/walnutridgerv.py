...
class walnutridgerv(scrapy.Spider):
    name = "walnutridgerv"


    def start_requests(self):
        web_links = {
            'Travel Trailer': 'https://www.walnutridgerv.com/rv-search?s=true&condition=1&pagesize=12&types=29',
            'FifthWheel': 'https://www.walnutridgerv.com/rv-search?s=true&condition=1&pagesize=12&types=5',
            'ToyHauler': 'https://www.walnutridgerv.com/rv-search?s=true&condition=1&pagesize=12&types=26%2C28',
            'ClassC Gas': 'https://www.walnutridgerv.com/rv-search?s=true&condition=1&pagesize=12&types=16',
            'ClassA Gas': 'https://www.walnutridgerv.com/rv-search?s=true&condition=1&pagesize=12&types=9',
            'Teardrop Trailer' : 'https://www.walnutridgerv.com/rv-search?s=true&condition=1&pagesize=12&types=102'
        }
    ...
    def parse_units(self, response):
        ...
        for unit in units:
            ...
            with open(f'DailyFiles/WalnutRidge {today}.csv', 'a', newline='') as file:
                writer = csv.writer(file, quoting=csv.QUOTE_ALL)
                if file.tell() == 0:  # If file is empty, write header
                    writer.writerow(['Year','Company','Brand','FloorPlan','Msrp','Discount','Stock-Number','Unit Type','Location','Dealer','Date'])
                
                writer.writerow([unit_year,unit_company,unit_brand,unit_floor,unit_msrp,unit_discount,unit_stock,unit_category,unit_location,'WalnutRidge',today])
