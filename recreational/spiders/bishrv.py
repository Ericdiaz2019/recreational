...
class bish(scrapy.Spider):
    name = "bish"


    def start_requests(self):
        web_links = {
        'Travel Trailer': 'https://www.bishs.com/new-rvs-for-sale?pagesize=12&s=true&types=29',
        'Fifth Wheel': 'https://www.bishs.com/new-rvs-for-sale?pagesize=12&s=true&types=5',
        'ToyHauler': 'https://www.bishs.com/new-rvs-for-sale?pagesize=12&s=true&types=26%2C28',
        'ClassC Gas': 'https://www.bishs.com/new-rvs-for-sale?pagesize=12&s=true&types=16',
        'ClassC Diesel': 'https://www.bishs.com/new-rvs-for-sale?pagesize=12&s=true&types=17',
        'ClassB Gas': 'https://www.bishs.com/new-rvs-for-sale?pagesize=12&s=true&types=13',
        'ClassB Diesel': 'https://www.bishs.com/new-rvs-for-sale?pagesize=12&s=true&types=116',
        'ClassB Plus': 'https://www.bishs.com/new-rvs-for-sale?pagesize=12&s=true&types=14',
        'ClassA Gas': 'https://www.bishs.com/new-rvs-for-sale?pagesize=12&s=true&types=9',
        'ClassA Diesel': 'https://www.bishs.com/new-rvs-for-sale?pagesize=12&s=true&types=10',
        'ClassA Toyhauler': 'https://www.bishs.com/new-rvs-for-sale?pagesize=12&s=true&types=12',
        'Destination Trailer' : 'https://www.bishs.com/new-rvs-for-sale?pagesize=12&s=true&types=3'
        }
    ...
    def parse_units(self, response):
        ...
        for unit in units:
            ...
            with open(f'DailyFiles/Bish {today}.csv', 'a', newline='') as file:
                writer = csv.writer(file, quoting=csv.QUOTE_ALL)
                if file.tell() == 0:  # If file is empty, write header
                    writer.writerow(['Year','Company','Brand','FloorPlan','Msrp','Discount','Stock-Number','Unit Type','Location','Dealer','Date'])
                
                writer.writerow([unit_year,unit_company,unit_brand,unit_floor,unit_msrp,unit_discount,unit_stock,unit_category,unit_location,'Bish',today])
