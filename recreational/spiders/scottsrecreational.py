...
class scottsrecreation(scrapy.Spider):
    name = "scottsrecreation"


    def start_requests(self):
        web_links = {
            'Travel Trailer': 'https://www.sr1rv.com/new-rvs-for-sale?s=true&types=29&pagesize=12',
            'FifthWheel': 'https://www.sr1rv.com/new-rvs-for-sale?s=true&types=5&pagesize=12',
            'ToyHauler': 'https://www.sr1rv.com/new-rvs-for-sale?s=true&types=26%2C28&pagesize=12',
            'ClassC Diesel': 'https://www.sr1rv.com/new-rvs-for-sale?s=true&types=17&pagesize=12',
            'ClassB Gas': 'https://www.sr1rv.com/new-rvs-for-sale?s=true&types=13&pagesize=12',
            'ClassB Diesel': 'https://www.sr1rv.com/new-rvs-for-sale?s=true&types=14&pagesize=12',
            ...
            'Folding Pop-Up Camper': 'https://www.sr1rv.com/new-rvs-for-sale?s=true&types=7&pagesize=12',
            'Teardrop Trailer': 'https://www.sr1rv.com/new-rvs-for-sale?s=true&types=102&pagesize=12',
            'Truck Camper': 'https://www.sr1rv.com/new-rvs-for-sale?s=true&types=30&pagesize=12',
            'Destination Trailer' : 'https://www.sr1rv.com/new-rvs-for-sale?s=true&types=3&pagesize=12'
        }
    ...
    def parse_units(self, response):
        ...
        for unit in units:
            ...
            with open(f'DailyFiles/Scotts Recreation {today}.csv', 'a', newline='') as file:
                writer = csv.writer(file, quoting=csv.QUOTE_ALL)
                if file.tell() == 0:  # If file is empty, write header
                    writer.writerow(['Year','Company','Brand','FloorPlan','Msrp','Discount','Stock-Number','Unit Type','Location','Dealer','Date'])
                
                writer.writerow([unit_year,unit_company,unit_brand,unit_floor,unit_msrp,unit_discount,unit_stock,unit_category,unit_location,'Scotts Recreation',today])
