...
class dadscamper(scrapy.Spider):
    name = "dadscamper"


    def start_requests(self):
        web_links = {
            'Travel Trailer': 'https://www.dadscamperoutlet.com/new-rvs-for-sale?pagesize=12&s=true&types=29',
            'FifthWheel': 'https://www.dadscamperoutlet.com/new-rvs-for-sale?pagesize=12&s=true&types=5',
            'ToyHauler': 'https://www.dadscamperoutlet.com/new-rvs-for-sale?pagesize=12&s=true&types=25%2C26%2C28',
            'Teardrop Trailer': 'https://www.dadscamperoutlet.com/new-rvs-for-sale?pagesize=12&s=true&types=102',
            'Destination Trailer': 'https://www.dadscamperoutlet.com/new-rvs-for-sale?pagesize=12&s=true&types=3',
            'ClassA Gas' : 'https://www.dadscamperoutlet.com/new-rvs-for-sale?pagesize=12&s=true&types=16'
        }
    ...
    def parse_units(self, response):
        ...
        for unit in units:
            ...
            with open(f'DailyFiles/DadsCamper {today}.csv', 'a', newline='') as file:
                writer = csv.writer(file, quoting=csv.QUOTE_ALL)
                if file.tell() == 0:  # If file is empty, write header
                    writer.writerow(['Year','Company','Brand','FloorPlan','Msrp','Discount','Stock-Number','Unit Type','Location','Dealer','Date'])
                
                writer.writerow([unit_year,unit_company,unit_brand,unit_floor,unit_msrp,unit_discount,unit_stock,unit_category,unit_location,'DadsCamper',today])
