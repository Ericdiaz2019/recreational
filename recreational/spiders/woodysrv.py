...
class woodys(scrapy.Spider):
    name = "woodys"


    def start_requests(self):
        web_links = {
            'Travel Trailer': 'https://www.woodysrv.com/rv-inventory/new/travel-trailer/?lengthf=0&lengthto=50&paymentf=0&paymentto=3000&pricef=0&priceto=1500000&sleepsf=0&sleepsto=15&sort-type=status-desc&page=1',
            'Fifth Wheel': 'https://www.woodysrv.com/rv-inventory/new/fifth-wheel/?lengthf=0&lengthto=50&paymentf=0&paymentto=3000&pricef=0&priceto=1500000&sleepsf=0&sleepsto=15&sort-type=status-desc&page=1',
            'ToyHauler': 'https://www.woodysrv.com/rv-inventory/new/toy-hauler/?lengthf=0&lengthto=50&paymentf=0&paymentto=3000&pricef=0&priceto=1500000&sleepsf=0&sleepsto=15&sort-type=status-desc',
            'ClassC Gas': 'https://www.parrisrv.com/rv-search?s=true&condition=1&types=16&pagesize=12',
            'ClassC Diesel': 'https://www.parrisrv.com/rv-search?s=true&condition=1&types=17&pagesize=12',
            'ClassC Super Diesel': 'https://www.parrisrv.com/rv-search?s=true&condition=1&types=95&pagesize=12',
            'ClassB Gas': 'https://www.parrisrv.com/rv-search?s=true&condition=1&types=13&pagesize=12',
            'ClassB Diesel': 'https://www.parrisrv.com/rv-search?s=true&condition=1&types=116&pagesize=12',
            'ClassA Gas': 'https://www.parrisrv.com/rv-search?s=true&condition=1&types=9&pagesize=12',
            'ClassA Diesel': 'https://www.parrisrv.com/rv-search?s=true&condition=1&types=10&pagesize=12',
            'Destination Trailer' : 'https://www.woodysrv.com/rv-inventory/new/park-model/?lengthf=0&lengthto=50&paymentf=0&paymentto=3000&pricef=0&priceto=1500000&sleepsf=0&sleepsto=15&sort-type=status-desc'
        }
    ...
    def parse_units(self, response):
        ...
        for unit in units:
            ...
            unit_location = unit.find('li', class_='location').text.replace('.','').replace(',','').replace('""','').replace('Parris RV','').replace('-','').replace(':','').strip()
            ...
            with open(f'DailyFiles/Parris {today}.csv', 'a', newline='') as file:
                writer = csv.writer(file, quoting=csv.QUOTE_ALL)
                if file.tell() == 0:  # If file is empty, write header
                    writer.writerow(['Year','Company','Brand','FloorPlan','Msrp','Discount','Stock-Number','Unit Type','Location','Dealer','Date'])
                
                writer.writerow([unit_year,unit_company,unit_brand,unit_floor,unit_msrp,unit_discount,unit_stock,unit_category,unit_location,'Parris',today])
