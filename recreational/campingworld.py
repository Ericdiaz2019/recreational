	...
	def get_page(self, page_num: int) -> dict:
		json_data = {
			...
			'pagination': {
				'page': page_num,
				'take': 12,
			}, 'sort': [], 'parameters': [{'comparisonOperator': '=', 	'value': '23455', 	'field': 'zipCode', }, {'comparisonOperator': '<=', 	'value': '999999', 	'field': 'distanceMiles', }, { 	'comparisonOperator': 'in', 	'value': 'b,fw,a,fth,c,tt,tc,ad,tth,cath,ccth,pu,sc,dt,ih', 	'field': 'rvClass', }, { 	'comparisonOperator': 'in', 	'value': 1, 	'field': 'domainId', },],
		}
